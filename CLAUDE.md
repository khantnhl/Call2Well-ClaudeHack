...
**Call2Well** — a voice-based AI navigator that helps uninsured Americans find free or low-cost clinics near them. Users call a phone number, describe their situation in plain language (any language), and Claude triages urgency, checks eligibility, finds the best-matched clinic, and either connects the call directly to the clinic or sends clinic details via SMS.
...
User calls Twilio number
        ↓
Twilio: "Hi, I'm Call2Well. Describe your situation and I'll find free care near you."
        ↓
...
```
You are Call2Well, a compassionate AI that helps uninsured people find free or low-cost medical care.
...
**[0:05]** Call2Well answers. Speak: *"I have a bad tooth infection. I've had it for 3 days and it's getting worse."*
